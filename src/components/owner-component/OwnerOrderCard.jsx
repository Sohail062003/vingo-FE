...
function OwnerOrderCard({ data }) {
  ...
  return (
    <div className="w-full mb-8 rounded-2xl bg-white/10 backdrop-blur-xl border border-white/20 shadow-xl overflow-hidden">
      ...
      {/* ================= FOOTER ================= */}
      <div className="px-5 py-4 bg-black/30 border-t border-white/20 flex flex-col sm:flex-row gap-3 sm:justify-end">
        <button className="w-full sm:w-auto px-5 py-2.5 rounded-xl bg-gradient-to-r from-orange-500 to-pink-500 text-white font-semibold hover:scale-[1.03] transition">
          View Order Details
        </button>
      </div>
    </div>
